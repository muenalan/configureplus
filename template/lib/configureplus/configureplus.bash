...
function configureplus_status
{
    ...
    warn_local '$CONFIGUREPLUS_DIR_OUT_SESSION=' $CONFIGUREPLUS_DIR_OUT_SESSIONS
        ...
        FOLDERS=$(echo ${CONFIGUREPLUS_DIR_CONFIG_FULL}/global ${CONFIGUREPLUS_DIR_CONFIG_FULL}/session/$CONFIGUREPLUS_SESSION $CONFIGUREPLUS_DIR_OUT/global $CONFIGUREPLUS_DIR_OUT_SESSIONS/$CONFIGUREPLUS_SESSION)
