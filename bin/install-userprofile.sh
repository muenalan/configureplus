...
warn_local "CHECK if ob is present in ${CONFIGURE_BASH_PROFILE_FILE}"
...
if [[ "$FLAG_PRESENT" ]]; then
    ...
    warn_local "CREATE userprofile copy to ${CONFIGURE_MKTEMP}/${CONFIGURE_BASH_PROFILE_FILE}.bak"
